 ...
 */
export const APP_NAME: string = 'Mash.fun Jersey Number Free Play';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'bet on cumulative jersey number scoring';
 ...
 */
export const APP_TAGS: string[] = ['sports', 'perps', 'betting', 'game', 'gambling'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Mash.fun Jersey # Free Play';
